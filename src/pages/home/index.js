...
import TabSection from "../../components/section3Tab";
import {
  allproductsFetch,
  filterproducts,
  changeCategory,
    ...
    <div>
      ...
      <div className="cat-names mt-[33px]">
        <div className=" text-center flex justify-center gap-8  font-bold text-xl">
          ...
          <h1
            onClick={(e) => changecat("ACCESSORIES", e)}
            className="line-hover"
          >
            {" "}
            ACCESSORIES
          </h1>
          <h1 onClick={(e) => changecat("FURNITURE", e)} className="line-hover">
            {" "}
            FURNITURE
          </h1>
        </div>
